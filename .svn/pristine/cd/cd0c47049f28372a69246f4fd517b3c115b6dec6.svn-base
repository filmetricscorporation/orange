        ...
        <form  id="punchTimeForm" method="post">
            ...
            <fieldset>
                ...
                <?php if ($isPunchInAllowed) : ?>
                    <p>
                        <input type="button" name="button" style="display:none;" class="punchInbutton" id="btnPunch" value="<?php echo __('In'); ?>" />
                    </p>
                <?php endif; ?>                
                <?php if ($isPunchOutAllowed) : ?>
                    <p>
                        <input type="button" name="button" style="display:none;" class="punchOutbutton" id="btnPunch" value="<?php echo __('Out'); ?>" />
                    </p>
                <?php endif; ?> 
            </fieldset>
        </form>
