...
class AddCandidateForm extends BaseForm {
    ...
    public function configure() {
        ...
        $sourceOfApplicationList = $this->getSourceOfApplicationList();
        ...
        $widgets = array(
            ...
            'sourceOfApplication' => new sfWidgetFormSelect(array('choices' => $sourceOfApplicationList)),
        );
        ...
        $validators = array(
            ...
            'sourceOfApplication' => new sfValidatorString(array('required' => false)),
    ...
    private function getSourceOfApplicationList() {
        $list = array("" => "-- " . __('Select') . " --");
        $vacancyProperties = array('name', 'id', 'hiringManagerId');
        $activeVacancyList = $this->getVacancyService()->getVacancyPropertyList($vacancyProperties, JobVacancy::ACTIVE);
