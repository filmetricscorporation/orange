...
class AuthenticationService extends BaseService {
    ...
    // 20160427 START
    public function getLoggedInAllowAccessConfidential() {
        $sfUser = sfContext::getInstance()->getUser();
        $allowAccessConfidential = $sfUser->getAttribute('auth.allowAccessConfidential');
        return $allowAccessConfidential;        
    }
    // END
    ...
    protected function setBasicUserAttributes(SystemUser $user) {
       ...
       $userRole = $user->getUserRole();
        ...
        //// 20160425
        $sfUser->setAttribute('auth.allowAccessConfidential', $user->getAllowAccessConfidential());
    }
    ...
    protected function setBasicUserAttributesToSession(SystemUser $user) {
        ...
        // 20160425
        $_SESSION['allowAccessConfidential'] = $user->getAllowAccessConfidential();
    }
