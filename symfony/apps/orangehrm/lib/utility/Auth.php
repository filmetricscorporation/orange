...
class Auth {
    ...
    // 20160425 Allow Access Confidential
    private $loggedInAllowAccessConfidential;
    /**
    ...
    private function __construct() {
    	...
    	if (isset($_SESSION['user'])) {
    		$this->loggedIn = true;
                ...
                $this->loggedInAllowAccessConfidential = $_SESSION['allowAccessConfidential'];
    ...
    public function getLoggedInAllowAccessConfidential() {
        return $this->loggedInAllowAccessConfidential;
    }
