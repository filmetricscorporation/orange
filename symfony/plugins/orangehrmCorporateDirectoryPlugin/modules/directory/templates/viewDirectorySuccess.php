...
if ((sizeof($list)) > 0) {
    ...
    <?php }; ?>
                    ...
                    <tr class="<?php echo $class; ?>">
                        <td>
                            <div align="center">                        
                                ...
                                <!-- 20160323 added employee id below the picture-->
                                <br/><span style="font-style:italic;"><?php echo $emp->getEmployeeId(); ?></span>
                            </div>
                        </td>
                        <td style='width: 90%;'>
                            <ul style='font-size: 20px;width: 50%;'>
                                ...
                                <li style='font-size: 12px;'><?php echo $emp->getEmployeeStatus(); ?></li>
        <?php $locs = $emp->getLocations(); ?>
                            ...
                            <!-- START 20160323 changed list into table to maximize space-->
                            <table class="table">
                                <tr>
                                    <td style='font-size: 12px;width:30%;'><strong>Job Title:</strong> <?php echo $emp->getJobTitleName(); ?></td>
                                    <td style='font-size: 12px;width:30%;'><strong>Status:</strong> <?php echo $emp->getEmployeeStatus(); ?></td>                                    
                                    <td style='font-size: 12px;width:30%;'><strong>Company Email:</strong> <?php echo $emp->getEmpWorkEmail(); ?></td>
                                </tr> 
                                 <tr>
                                    <td style='font-size: 12px;width:30%;'><strong>Group/Division:</strong> <?php echo $emp->getSubDivision(); ?></td>
                                    <td style='font-size: 12px;width:30%;'><strong>Joined Date:</strong> <?php echo $emp->getJoinedDate(); ?></td>
                                    <?php
                                        $contact_number = $emp->getEmpHmTelephone();

                                        if (($emp->getEmpHmTelephone() == NULL) || ($emp->getEmpHmTelephone() == "")) {
                                            $contact_number = $emp->getEmpMobile();
                                        }
                                    ?>
                                    <td style='font-size: 12px;width:30%;'><strong>Phone:</strong> <?php echo $contact_number; ?></td>
                                </tr>                                           
                            </table>
                            <!-- END -->
                        </td>
