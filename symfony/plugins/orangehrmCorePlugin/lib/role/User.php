...
class User {
	...
	// 20160425
	private $allowAccessConfidential;
	...
	public function getAllowAccessConfidential() {

		//return $this->allowAccessConfidential;
		return 2;
	}

	public function setAllowAccessConfidential($allowAccessConfidential) {

		$this->allowAccessConfidential = $allowAccessConfidential;
	}
