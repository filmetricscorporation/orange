...
<?php 
use_javascript(plugin_web_path('orangehrmRecruitmentPlugin', 'js/viewApplicationSourcesSuccess'));
?>

<div class="box" id="saveFormDiv">
    
    <div class="head">
            <h1 id="saveFormHeading">Add Application Source</h1>
    </div>
    
    <div class="inner">
        
        <form name="frmSave" id="frmSave" method="post" action="<?php echo url_for('recruitment/viewApplicationSources'); ?>">
...
<div id="recordsListDiv" class="box miniList">
    <div class="head">
            <h1><?php echo __('Application Sources'); ?></h1>
    </div>
    ...
    <div class="inner">
        ...
        <form name="frmList" id="frmList" method="post" action="<?php echo url_for('recruitment/deleteApplicationSources'); ?>">
            <?php echo $listForm ?>
            <p id="listActions">
...
//<![CDATA[	    
    ...
    var recordKeyId = "applicationSource_id";
   
    var saveFormFieldIds = new Array();
    saveFormFieldIds[0] = "applicationSource_name";
    saveFormFieldIds[1] = "applicationSource_description";
    
    var urlForExistingNameCheck = '<?php echo url_for('recruitment/checkApplicationSourceNameExistence'); ?>';
    
    var lang_addFormHeading = "<?php echo __('Add Application Source'); ?>";
    var lang_editFormHeading = "<?php echo __('Edit Application Source'); ?>";
    ...
    var applicationSource = <?php echo str_replace('&#039;', "'", $form->getApplicationSourceListAsJson()) ?> ;
    var applicationSourceList = eval(applicationSource);
