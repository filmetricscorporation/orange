        ...
        <form name="frmAddCandidate" id="frmAddCandidate" method="post" action="<?php echo url_for('recruitment/addCandidate?id=' . $candidateId); ?>" enctype="multipart/form-data">
            ...
            <fieldset>
                ...
                <ol>
                    ...
                    <li>
                        <?php echo $form['sourceOfApplication']->renderLabel(__('Source Of Application'), array("class" => "sourceOfApplicationDrpLabel")); ?>
                        <?php echo $form['sourceOfApplication']->render(array("class" => "sourceOfApplicationDrp")); ?>
                    </li>
