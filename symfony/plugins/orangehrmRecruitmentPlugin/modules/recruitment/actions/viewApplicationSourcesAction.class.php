...
class viewApplicationSourcesAction extends sfAction {
    ...
    public function execute($request) {
        ...
        $this->form = new ApplicationSourceForm();
        
        $this->records = $this->getApplicationSourceService()->getApplicationSourceList();
        ...
        if ($request->isMethod('post')) {
			...
			if ($this->form->isValid()) {
                ...
                $this->redirect('recruitment/viewApplicationSources');
    ...
    protected function _checkDuplicateEntry() {
        ...
        $object = $this->getApplicationSourceService()->getApplicationSourceByName($this->form->getValue('name'));
        
        if ($object instanceof ApplicationSource) {
