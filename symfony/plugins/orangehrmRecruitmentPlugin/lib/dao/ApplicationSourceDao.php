 ...
 */
class ApplicationSourceDao extends BaseDao {
    ...
    public function getApplicationSourceById($id) {
        ...
        try {
            return Doctrine::getTable('ApplicationSource')->find($id);
        } catch (Exception $e) {
            throw new DaoException($e->getMessage(), $e->getCode(), $e);
        }
    ...
    public function getApplicationSourceList() {
        ...
        try {
            ...
            $q = Doctrine_Query::create()->from('ApplicationSource')
                                         ->orderBy('name');
    ...
    public function deleteApplicationSources($toDeleteIds) {
        ...
        try {
            ...
            $q = Doctrine_Query::create()->delete('ApplicationSource')
    ...
    public function isExistingApplicationSourceName($applicationSourceName) {
        ...
        try {
            ...
            $q = Doctrine_Query:: create()->from('ApplicationSource l')
                            ->where('l.name = ?', trim($applicationSourceName));
