...
class WorkShiftForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            //// 20160502
            'firstHalfEndTime' => new sfWidgetFormInputText(),
            'secondHalfStartTime' => new sfWidgetFormInputText(),
        ));
        ...
        $this->setValidators(array(
            ...
            //// 20160502
            //'firstHalfEndTime' => new sfValidatorString(),
            //'secondHalfStartTime' => new sfValidatorString(),
        ));
        ...
        $labels = array(
            ...
            //// 20160502
            //'firstHalfEndTime' => __('1st Half End Time') . $requiredMarker,
            //'secondHalfStartTime' => __('2nd Half Start Time') . $requiredMarker,
        );
    ...
    public function save() {
        ...
        // 20160502
        // START
        $workShift->setFirstHalfStartTime($workHours['from']);
        $workShift->setFirstHalfEndTime($workHours['from']);
        $workShift->setSecondHalfStartTime($workHours['to']);
        $workShift->setSecondHalfEndTime($workHours['to']);
        // END
    ...
    public function getEmployeeList() {
        ...
        $employeeList = $this->getEmployeeService()->getEmployeePropertyList($properties, 'lastName', 'ASC', true, true);
