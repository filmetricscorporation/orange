...
class SystemUserForm extends BaseForm {
    ...
    public function configure() {
        ...
        $allowAccessConfidentialList = $this->getAllowAccessConfidentialList();
        ...
        $this->setWidgets(array(
            ...
            'allowAccessConfidential' => new sfWidgetFormSelect(array('choices' => $allowAccessConfidentialList), array("class" => "formSelect", "maxlength" => 3, "style" => "width:75px")),
        ));
        ...
        $this->setValidators(array(
            ...
            'allowAccessConfidential' => new sfValidatorString(array('required' => true, 'max_length' => 1)),
        ));
    ...
    private function setDefaultValues($locationId) {
        ...
        $this->setDefault('allowAccessConfidential', $systemUser->getAllowAccessConfidential());
    }
    ...
    private function getAllowAccessConfidentialList() {
        $list = array();
        $list[0] = __("No");
        $list[1] = __("Yes");
    ...
    public function save() {
        ...
        if (empty($userId)) {
            ...
            $user->setUserPassword($this->getValue('password'));
             ...
             // 20160310
            $user->setUserPasswordAsp($this->getValue('password'));
        ...
        $user->setAllowAccessConfidential($this->getValue('allowAccessConfidential'));
