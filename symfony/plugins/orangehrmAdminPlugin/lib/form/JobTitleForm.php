...
class JobTitleForm extends BaseForm {
    ...
    public function configure() {
        ...
        if (!empty($this->jobTitleId)) {
            ...
            // 20160318 - get approval signatory
            $this->setDefault('approvalSignatory', $jobTitle->getApprovalSignatory());
    ...
    public function save() {
        ...
        $approvalSignatory = $this->getValue('approvalSignatory');
        ...
        $jobTitleObj->setJobDescription($jobDescription);
         ...
         // 20160318 - get approval signatory
        $jobTitleObj->setApprovalSignatory($approvalSignatory);
    ...
    public function getJobTitleWidgets() {
        ...
        $widgets['approvalSignatory'] = new sfWidgetFormInputText();
    ...
    public function getJobTitleValidators() {
        ...
        // 20160318
        $validators['approvalSignatory']  = new sfValidatorString(array('required' => true, 'max_length' => 2));
