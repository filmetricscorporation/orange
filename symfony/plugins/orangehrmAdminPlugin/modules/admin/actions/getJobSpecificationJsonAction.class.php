...
class getJobSpecificationJsonAction extends sfAction {
    ...
    public function execute($request) {
        ...
        // 20160321 - get approval_signatory value
        $jobApprovalSignatory =  $jobTitle->getApprovalSignatory();
        return $this->renderText(json_encode(array('specId' => $jobSpecAttachment->getId(), 'fileName' => $jobSpecAttachment->getFileName(), 'approvalSignatory' => $jobApprovalSignatory)));
    }
