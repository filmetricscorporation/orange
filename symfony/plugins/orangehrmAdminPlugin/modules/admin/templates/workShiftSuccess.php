        ...
        <form name="frmWorkShift" id="frmWorkShift" method="post" action="<?php echo url_for('admin/workShift'); ?>" >
            ...
            <fieldset>
                ...
                <ol>                    
                    ...
                    <li>
                        <?php echo $form['firstHalfEndTime']->renderLabel(); ?>
                        <?php echo $form['firstHalfEndTime']->render(); ?>
                    </li>
                    <li>
                        <?php echo $form['secondHalfStartTime']->renderLabel(); ?>
                        <?php echo $form['secondHalfStartTime']->render(); ?>
                    </li>
              

                    <?php
                    // 20160502 - commented since Work Shift is moved to the PIM Module
                    // START
