...
class EmployeeService extends BaseService {
    ...
    */
    ...
    public function getEmployeeFamilyMembers($empNumber) {
        return $this->getEmployeeDao()->getEmployeeFamilyMembers($empNumber);
    }

    public function deleteEmployeeFamilyMembers($empNumber, $sequenceNumbers = null) {
        return $this->getEmployeeDao()->deleteEmployeeFamilyMembers($empNumber, $sequenceNumbers);
    }
     ...
     * @version 2.6.11
     * @param int $empNumber Employee Number
     * @param int $skillCode Character Reference Code
     * @return Doctrine_Collection/EmployeeCharacterReference 
     * 
     ...
     * 
     * @version 2.6.11
     * @param EmployeeCharacterReference $characterReference EmployeeCharacterReference object to save
     * @return EmployeeCharacterReference Saved EmployeeCharacterReference object
     * 
     * @todo reurn saved Employee CharacterReference object [DONE]
     * @todo rename method as saveEmployeeCharacterReference [DONE]
     */
    public function saveEmployeeCharacterReference(EmployeeCharacterReference $characterReference) {
        return $this->getEmployeeDao()->saveEmployeeCharacterReference($characterReference);
    }
    ...
    public function getEmployeePropertyList($properties, $orderField, $orderBy, $excludeTerminatedEmployees = false, $excludeResignedEmployees = false) {
        return $this->getEmployeeDao()->getEmployeePropertyList($properties, $orderField, $orderBy, $excludeTerminatedEmployees, $excludeResignedEmployees);
    }
    ...
    */
    ...
    public function getEmployeeSalaries($empNumber, $empSalaryId = null) {
     ...
     public function getEmployeeWorkShifts($empNumber, $empSalaryId = null) {
        return $this->getEmployeeDao()->getEmployeeWorkShifts($empNumber, $empSalaryId);
    }  
