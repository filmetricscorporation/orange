...
class WorkExperienceForm extends sfForm {
    ...
    public function getWorkExperienceWidgets() {
        ...
        $widgets['superior'] = new sfWidgetFormInputText();
        $widgets['address'] = new sfWidgetFormInputText();
        $widgets['salary'] = new sfWidgetFormInputText();
        $widgets['contactno'] = new sfWidgetFormInputText();
    ...
    public function getWorkExperienceValidators() {
        ...
        $validators = array(
            ...
            'superior' => new sfValidatorString(array('required' => false, 'max_length' => 100)),
            'address' => new sfValidatorString(array('required' => false, 'max_length' => 150)),
            'salary' => new sfValidatorString(array('required' => false, 'max_length' => 10)),
            'contactno' => new sfValidatorString(array('required' => false, 'max_length' => 30))
        );
