...
class EmployeePersonalDetailsForm extends BaseForm {
    ...
    private function getPersonalInfoWidgets() {
        $widgets = array(
            ...
            'chkIsConfidential' => new sfWidgetFormInputCheckbox(),
            'txtLicExpDate' => new ohrmWidgetDatePicker(array(), array('id' => 'personal_txtLicExpDate')),
            'txtMilitarySer' => new sfWidgetFormInputText(),

            // 20160328 - add new fields
            'txtSssNumber' => new sfWidgetFormInputText(),
            'txtPhilhealthNumber' => new sfWidgetFormInputText(),
            'txtTin' => new sfWidgetFormInputText(),
            'txtPagibigNumber' => new sfWidgetFormInputText(),
            'txtHeight' => new sfWidgetFormInputText(),
            'txtHeightFt' => new sfWidgetFormInputText(),
            'txtHeightInch' => new sfWidgetFormInputText(),
            'txtWeight' => new sfWidgetFormInputText(),
            'txtWeightLbs' => new sfWidgetFormInputText(),
        ...
        if ($this->employee->is_confidential) {
            $widgets['chkIsConfidential']->setAttribute('checked', 'checked');
        }

        $widgets['chkSmokeFlag']->setAttribute('value', 1);
        $widgets['chkIsConfidential']->setAttribute('value', 1);
        ...
        // 20160328 - set values of other ids
        $widgets['txtSssNumber']->setAttribute('value', $this->employee->sss_number);
        $widgets['txtPhilhealthNumber']->setAttribute('value', $this->employee->philhealth_number);
        $widgets['txtTin']->setAttribute('value', $this->employee->tin);
        $widgets['txtPagibigNumber']->setAttribute('value', $this->employee->pagibig_number);
        $widgets['txtHeight']->setAttribute('value', $this->employee->height);
        $widgets['txtWeight']->setAttribute('value', $this->employee->weight);
    ...
    private function getPersonalInfoValidators() {
        ...
        $validators = array(
            ...
            'chkIsConfidential' => new sfValidatorString(array('required' => false)),
            ...
            'txtSssNumber' => new sfValidatorString(array('required' => false)),
            'txtPhilhealthNumber' => new sfValidatorString(array('required' => false)),
            'txtPagibigNumber' => new sfValidatorString(array('required' => false)),
            'txtTin' => new sfValidatorString(array('required' => false)),
            'txtHeight' => new sfValidatorString(array('required' => false)),
            'txtHeightFt' => new sfValidatorString(array('required' => false)),
            'txtHeightInch' => new sfValidatorString(array('required' => false)),
            'txtWeight' => new sfValidatorString(array('required' => false)),
            'txtWeightLbs' => new sfValidatorString(array('required' => false))
        );
    ...
    public function getEmployee() {
        ...
        if ($this->personalInformationPermission->canUpdate()) {
            ...
            // 20160328 - added
            $employee->sss_number = $this->getValue('txtSssNumber');
            $employee->philhealth_number = $this->getValue('txtPhilhealthNumber');
            $employee->pagibig_number = $this->getValue('txtPagibigNumber');
            $employee->tin = $this->getValue('txtTin');
            $employee->height = $this->getValue('txtHeight');
            $employee->weight = $this->getValue('txtWeight');
           
            $employee->emp_marital_status = $this->getValue('cmbMarital');
            $smoker = $this->getValue('chkSmokeFlag');
            $isconfidential = $this->getValue('chkIsConfidential');
            $employee->smoker = !empty($smoker) ? $smoker : 0;
            $employee->is_confidential = !empty($isconfidential) ? $isconfidential : 0;
            ...
            //$smoker = $this->getValue('chkIsConfidential');
