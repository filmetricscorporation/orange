...
class AddEmployeeForm extends sfForm {
    ...
    public function configure() {
        ...
        $this->widgets = array(
            ...
            'lastName' => new sfWidgetFormInputText(array(), array("class" => "formInputText", "maxlength" => 30)),
             // 20160314 changed maxlength from 10 t0 20
            'employeeId' => new sfWidgetFormInputText(array(), array("class" => "formInputText", "maxlength" => 20)),
            // 20160314 - removed uploading of image since image is set via Sir Tony's UI
       ...
       //$this->widgets['employeeId']->setDefault($employeeId);
        ...
        $this->setValidators(array(
            ...
            // 20160314 changed maxlength from 10 t0 20
            'employeeId' => new sfValidatorString(array('required' => true, 'max_length' => 20, 'trim' => true)),
    ...
    public function save() {
        ...
        $employee->setCreatedBy(sfContext::getInstance()->getUser()->getAttribute('user')->getUserId());
