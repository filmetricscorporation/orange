...
class EmployeeJobDetailsForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            //'job_title' => new sfWidgetFormChoice(array('choices' => $jobTitles)),
        ...
        //var_dump($employee->emp_status);

        // 20160321 - set default approval_signatory value
        $this->setDefault('approval_signatory', $employee->approval_signatory);
    ...
    public function getEmployee() {
        ...
        //// 20160321 - approval_signatory
        $empApprovalSignatory = $this->getValue('approval_signatory');
        if ($empApprovalSignatory == '') {
            $employee->approval_signatory = null;
        } else {
