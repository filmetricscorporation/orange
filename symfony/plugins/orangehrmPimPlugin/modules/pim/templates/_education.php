        ...
        <form id="frmEducation" action="<?php echo url_for('pim/saveDeleteEducation?empNumber=' . 
            ...
            <fieldset>
                <ol>
                    ...
                    <li>
                        <?php echo $form['year']->renderLabel(__('Year') . ' <em>*</em>'); ?>
                    ...
                    */
                    ?>
                    <li>
                        <?php echo $form['start_date']->renderLabel(__('Start Date') . ' <em>*</em>'); ?>
                        <?php echo $form['start_date']->render(array("class" => "formInputText")); ?>
                    </li>
                    <li>
                        <?php echo $form['end_date']->renderLabel(__('End Date') . ' <em>*</em>'); ?>
                ...
                <table width="100%" cellspacing="0" cellpadding="0" class="table tablesorter">
                    <thead>
                        <tr>
                            ...
                            <th width="5%"><?php echo __('Year'); ?></th>
                            <!--<th><?php /*echo __('GPA/Score');*/ ?></th>-->
                            <th><?php echo __('Institute'); ?></th>
                            <th width="5%"><?php echo __('Major/Specialization'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
    ...
    $(document).ready(function() {
        ...
        var educationValidator =
            ...
            rules: {
                ...
                'education[year]': {required: true, digits: true},
                'education[gpa]': {required: false, maxlength: 25},
                'education[start_date]': {valid_date: function(){return {format: datepickerDateFormat, required:true, displayFormat:displayDateFormat}}},
                'education[end_date]': {valid_date: function(){return {format:datepickerDateFormat, required:true, displayFormat:displayDateFormat}}, date_range: function() {return {format:datepickerDateFormat, displayFormat:displayDateFormat, fromDate:startDate}}}
            },
            messages: {
