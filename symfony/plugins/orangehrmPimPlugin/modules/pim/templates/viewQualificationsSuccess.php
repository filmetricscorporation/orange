...
<?php use_javascripts_for_form($characterReferenceForm) ?>
<?php use_stylesheets_for_form($characterReferenceForm) ?>
...
<!--    
                ...
                <form id="frmWorkExperience" action="<?php echo url_for('pim/saveDeleteWorkExperience?empNumber=' . 
                    ...
                    <fieldset>
                        <ol>
                            ...
                            <li>
                                <?php echo $workExperienceForm['superior']->renderLabel(__('Immediate Superior')); ?>
                                <?php echo $workExperienceForm['superior']->render(array("class" => "formInputText", "maxlength" => 100)); ?>
                            </li>
                            <li>
                                <?php echo $workExperienceForm['address']->renderLabel(__('Address')); ?>
                                <?php echo $workExperienceForm['address']->render(array("class" => "formInputText", "maxlength" => 150, "style"=>"width:70%")); ?>
                            </li>
                           <li>
                                <?php echo $workExperienceForm['contactno']->renderLabel(__('Contact Number')); ?>
                                <?php echo $workExperienceForm['contactno']->render(array("class" => "formInputText", "maxlength" => 30)); ?>
                            </li>
                            <li>
                                <?php echo $workExperienceForm['salary']->renderLabel(__('Salary')); ?>
                                <?php echo $workExperienceForm['salary']->render(array("class" => "formInputText", "maxlength" => 10)); ?>
                            </li>
                            <li>
                                ...
                                foreach ($workExperiences as $workExperience) :
                                    ...
                                    <tr class="<?php echo $cssClass;?>">
                                        <td class="check">
                                            ...
                                            <input type="hidden" id="superior_<?php echo $workExperience->seqno; ?>" 
                                                   value="<?php echo htmlspecialchars($workExperience->superior); ?>" />
                                            <input type="hidden" id="address_<?php echo $workExperience->seqno; ?>" 
                                                   value="<?php echo htmlspecialchars($workExperience->address); ?>" />
                                            <input type="hidden" id="contactno_<?php echo $workExperience->seqno; ?>" 
                                                   value="<?php echo htmlspecialchars($workExperience->contactno); ?>" />
                                            <input type="hidden" id="salary_<?php echo $workExperience->seqno; ?>" 
                                                   value="<?php echo $workExperience->salary; ?>" />                                     
                                            <?php if ($workExperiencePermissions->canDelete()) {?>
    ...
    <!-- this is charater reference section -->
    <?php
    include_partial('characterReference', array('empNumber' => $empNumber, 'form' => $characterReferenceForm, 
        'section' => $section, 'characterReferencePermissions' => $characterReferencePermissions,'listForm'=>$listForm));
    ?>
