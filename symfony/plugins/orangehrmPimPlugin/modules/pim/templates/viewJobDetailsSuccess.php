            ...
            if(jobTitle != ""){
                ...
                $.getJSON(specUrl, function(data) {
                    ...
                    if (data) {
                        ...
                        // 20160321 - approval_signatory, this will set the value based on ohrm_job_title table
                        approvalSignatory = data.approvalSignatory;
                        $("#job_approval_signatory").val(data.approvalSignatory);
