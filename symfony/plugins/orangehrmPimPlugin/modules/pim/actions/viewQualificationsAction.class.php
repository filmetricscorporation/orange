...
class viewQualificationsAction extends basePimAction {
    ...
    public function execute($request) {
        ...
        //var_dump($this->characterReferencePermissions);
        ...
        $this->setCharacterReferenceForm(new EmployeeCharacterReferenceForm(array(), array('empNumber' => $empNumber, 
            'characterReferencePermissions' => $this->characterReferencePermissions), true));
