 ...
 * @property Doctrine_Collection $characterReference
 ...
 * @method string                    getPagibigNumber()				 Returns the current record's "pagibig_number" value
 ...
 * @method Doctrine_Collection       getCharacterReference()         Returns the current record's "characterReference" collection
 ...
 * @method Employee                  setPagibigNumber()			     Sets the current record's "pagibig_number" value
 * @method Employee                  setTin()					     Sets the current record's "tin" value   
 * @method Employee                  setHeight()					 Sets the current record's "height" value   
 * @method Employee                  setWeight()					 Sets the current record's "weight" value   
 ...
 * @method Employee                  setCreatedBy()                  Sets the current record's "created_by" value
 ...
 * @method Employee                  setCharacterReference()         Sets the current record's "characterReference" collection
...
abstract class BaseEmployee extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
       ...
       $this->hasColumn('emp_other_id as otherId', 'string', 100, array(
        ...
        // 20160328 - added new fields
        // START
        /*
        $this->hasColumn('emp_philhealth_number as philhealthNumber', 'string', 50, array(
             'type' => 'string',
             'default' => '',
             'length' => 50,
             ));
        $this->hasColumn('emp_tin as tin', 'string', 50, array(
             'type' => 'string',
             'default' => '',
             'length' => 50,
             ));
        $this->hasColumn('emp_pagibig_number as pagibigNumber', 'string', 50, array(
             'type' => 'string',
             'default' => '',
             'length' => 50,
             ));*/
        ...
        $this->hasColumn('approval_signatory', 'integer', 2, array(
             'type' => 'integer',
             'length' => 2,
             ));
        $this->hasColumn('is_confidential', 'integer', 1, array(
             'type' => 'integer',
             'length' => 1,
             ));
        $this->hasColumn('philhealth_number', 'string', 50, array(
             'type' => 'string',
             'default' => '',
             'length' => 50,
             ));
        $this->hasColumn('pagibig_number', 'string', 50, array(
             'type' => 'string',
             'default' => '',
             'length' => 50,
             ));
        ...
        $this->hasColumn('sss_number', 'string', 50, array(
             'type' => 'string',
             'default' => '',
             'length' => 50,
             ));
         $this->hasColumn('height', 'string', 10, array(
             'type' => 'string',
             'default' => '',
             'length' => 10,
             ));
        ...
        $this->hasColumn('custom10', 'string', 250, array(
         ...
         $this->hasColumn('created_by', 'integer', 7, array(
             'type' => 'integer',
             'length' => 7,
             ));
    }
    ...
    public function setUp()
    {
        ...
        $this->hasMany('EmpCharacterReference as characterReference', array(
             'local' => 'emp_number',
             'foreign' => 'emp_number'));
        ...
        $this->hasOne('SssNumber', array(
         ...
         $this->hasOne('PhilhealthNumber', array(
             'local' => 'philhealth_number',
             'foreign' => 'philhealth_number'));

        $this->hasOne('PagibigNumber', array(
            'local' => 'pagibig_number',
            'foreign' => 'pagibig_number'));

       	$this->hasOne('Tin', array(
        	'local' => 'tin',
        	'foreign' => 'tin'));

       	$this->hasOne('Height', array(
        	'local' => 'height',
        	'foreign' => 'height'));

       	$this->hasOne('Weight', array(
        	'local' => 'weight',
        	'foreign' => 'weight'));
