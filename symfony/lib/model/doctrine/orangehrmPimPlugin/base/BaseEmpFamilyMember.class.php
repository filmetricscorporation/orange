 ...
 * @method EmpDependent setOccupation()        Sets the current record's "occupation" value
 ...
 */
abstract class BaseEmpFamilyMember extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('hs_hr_emp_family_members');
        $this->hasColumn('emp_number', 'integer', 4, array(
             'type' => 'integer',
             'primary' => true,
             'length' => 4,
             ));
        $this->hasColumn('ef_seqno as seqno', 'decimal', 2, array(
             'type' => 'decimal',
             'primary' => true,
             'length' => 2,
             ));
        $this->hasColumn('ef_name as name', 'string', 100, array(
             'type' => 'string',
             'default' => '',
             'length' => 100,
             ));
        $this->hasColumn('ef_relationship_type as relationship_type', 'enum', null, array(
             'type' => 'enum',
             'values' => 
             array(
              0 => 'child',
        ...
        $this->hasColumn('ef_relationship as relationship', 'string', 100, array(
             'type' => 'string',
             'default' => '',
             'length' => 100,
             ));
        $this->hasColumn('ef_date_of_birth as date_of_birth', 'date', 25, array(
             'type' => 'date',
             'length' => 25,
             ));
        $this->hasColumn('ef_occupation as occupation', 'string', 100, array(
             'type' => 'string',
             'default' => '',
             'length' => 100,
             ));
