 ...
 * @property time $first_half_start_time
 * @property time $first_half_end_time
 * @property time $second_half_start_time
 * @property time $second_half_end_time
 ...
 * @method time                getFirstHalfStartTime()      Returns the current record's "first_half_start_time" value
 * @method time                getFirstHalfEndTime()        Returns the current record's "first_half_end_time" value
 * @method time                getSecondHalfStartTime()     Returns the current record's "second_half_start_time" value
 * @method time                getSecondHalfEndTime()       Returns the current record's "second_half_end_time" value
 ...
 * @method WorkShift           setFirstHalfStartTime()      Sets the current record's "first_half_start_time" value
 * @method WorkShift           setSecondHalfEndTime()       Sets the current record's "first_half_end_time" value
 * @method WorkShift           setFirstHalfStartTime()      Sets the current record's "second_half_start_time" value
 * @method WorkShift           setSecondHalfEndTime()       Sets the current record's "second_half_end_time" value
...
abstract class BaseWorkShift extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('first_half_start_time', 'time', null, array(
             'type' => 'time',
             'notnull' => true,
             ));
        $this->hasColumn('first_half_end_time', 'time', null, array(
             'type' => 'time',
             'notnull' => true,
             ));
        $this->hasColumn('second_half_start_time', 'time', null, array(
             'type' => 'time',
             'notnull' => true,
             ));
        $this->hasColumn('second_half_end_time', 'time', null, array(
             'type' => 'time',
             'notnull' => true,
             ));
    }
