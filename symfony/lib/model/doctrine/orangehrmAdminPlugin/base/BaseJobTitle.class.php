 ...
 * @method integer                    getApprovalSignatory()          Returns the current record's "approvalSignatory" value (20160318)
 ...
 * @method JobTitle                   setApprovalSignatory()          Sets the current record's "approvalSignatory" value (20160318)
...
abstract class BaseJobTitle extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        // 20160318 - added approval_signatory field
        $this->hasColumn('approval_signatory as approvalSignatory', 'integer', 2, array(
             'type' => 'integer',
             'length' => 2,
             ));
