...
abstract class BaseEmployeeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'approval_signatory'    => new sfWidgetFormFilterInput(),
      'sss_number'            => new sfWidgetFormFilterInput(),
      'philhealth_number'     => new sfWidgetFormFilterInput(),
      'pagibig_number'        => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'approval_signatory'    => new sfValidatorPass(array('required' => false)),
      'sss_number'            => new sfValidatorPass(array('required' => false)),
      'philhealth_number'     => new sfValidatorPass(array('required' => false)),
      'pagibig_number'        => new sfValidatorPass(array('required' => false)),
