...
abstract class BaseEmployeeForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'approval_signatory'    => new sfWidgetFormTextarea(),
      'sss_number'            => new sfWidgetFormInputText(),
      'philhealth_number'     => new sfWidgetFormInputText(),
      'pagibig_number'        => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'otherId'               => new sfValidatorString(array('max_length' => 50, 'required' => false)),
      ...
      'approval_signatory'    => new sfValidatorString(array('max_length' => 2, 'required' => false)),
      'sss_number'            => new sfValidatorString(array('max_length' => 50, 'required' => false)),
      'philhealth_number'     => new sfValidatorString(array('max_length' => 50, 'required' => false)),
      'pagibig_number'        => new sfValidatorString(array('max_length' => 50, 'required' => false)),
      ...
      'weight'                => new sfValidatorString(array('max_length' => 7, 'required' => false)),
